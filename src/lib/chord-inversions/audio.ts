...
export async function playInversionNote(engine: PianoAudioEngine, noteOrMidi: string | number, durationMs = 420) {
...
export async function playChordInversion(engine: PianoAudioEngine, inversionId: string, durationMs = 760) {
...
export async function playInversionComparison(engine: PianoAudioEngine, rootPositionId: string, inversionId: string) {
