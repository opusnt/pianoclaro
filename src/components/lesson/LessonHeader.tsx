...
export function LessonHeader({ lesson, sectionLabel = "Lección" }: LessonHeaderProps) {
  return (
      ...
      <div className="flex flex-col gap-4 xl:flex-row xl:items-end xl:justify-between">
        <div>
          <p className="text-sm font-bold text-gold-soft">
            {sectionLabel} {lesson.order} · {lesson.level} · {lesson.estimatedMinutes} min
          </p>
          <h1 className="mt-2 text-2xl font-bold text-blue-deep sm:text-3xl xl:text-4xl">
            {lesson.title}
          </h1>
