...
import { HarmonicFieldBadge } from "@/components/modules/harmonic-field/HarmonicFieldBadge";
import { HarmonicFieldFeedback } from "@/components/modules/harmonic-field/HarmonicFieldFeedback";
import { HarmonicFieldKeyboard } from "@/components/modules/harmonic-field/HarmonicFieldKeyboard";
...
function QuestionPanel({ question }: { question?: HarmonicFieldQuestion }) {
  const field = question ? requireField(question.fieldId) : undefined;
  const chord = question?.degree && field ? getChordByDegree(field, question.degree) : undefined;
