...
export function MinorScaleKeyboard({
  tonicMidi,
  expectedMidi,
  selectedNote,
  completedMidiNotes,
  ...
  const differenceSet = new Set(differenceMidiNotes);

  return (
    <div className="rounded-2xl border border-blue-deep/10 bg-ivory p-4">
      <div className="flex items-center justify-between gap-3">
        <p className="text-xs font-bold uppercase text-muted">Teclado de escala menor</p>
...
function getKeyClass(input: KeyStateInput) {
  ...
  if (input.differenceSet.has(input.midi)) {
