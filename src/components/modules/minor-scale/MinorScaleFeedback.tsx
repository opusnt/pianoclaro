...
import type { MinorScaleAnswer } from "@/types/minor-scale";

type MinorScaleFeedbackProps = {
  message: string;
  answer?: MinorScaleAnswer | null;
};

export function MinorScaleFeedback({ message, answer }: MinorScaleFeedbackProps) {
