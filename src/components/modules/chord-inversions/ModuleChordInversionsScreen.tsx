...
import {
  trackChordInversionAttempt,
  trackChordInversionEvent,
} from "@/lib/chord-inversions/analytics";
...
export function ModuleChordInversionsScreen({ module }: ModuleChordInversionsScreenProps) {
  const { progress, saveAttempt, resetProgress } = useChordInversionProgress(
    module.id,
    module.exercises,
  );
          ...
          <div className="flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
            <div>
              ...
              <p className="mt-4 max-w-3xl rounded-2xl bg-cream/70 p-4 text-sm font-semibold leading-6 text-blue-deep">
                Una inversión no cambia el acorde: cambia qué nota queda en el bajo para tocar con
                menos movimiento.
              </p>
            </div>
            <button
